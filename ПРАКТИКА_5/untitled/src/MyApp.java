...
class MyApp extends JFrame
{
    ...
    String background_image_path = "C:/Java/Практика/ПРАКТИКА_5/background.jpg";
    String animation_images_path = "C:/Java/Практика/ПРАКТИКА_5/frames/";
    int method;

    // Init
    MyApp() {
        super("Some shapes");
        setSize(WINDOW_WIDTH -20, WINDOW_HEIGHT -20);
    ...
    void random_shapes_paint(int choice, Graphics2D g)
    {   int k = 0;
        for (int i = 0; i < choice; i++)
        {
            ...
            switch (k)
            {
                ...
                case 1:
                    ...
                    g.fillOval(
                            (int) (Math.random() * WINDOW_WIDTH - 170),
                            (int) (Math.random() * WINDOW_HEIGHT - 170),
                            (int) (100),
                            (int) (115)
                    );
                    break;
                ...
                // Rect
                case 2:
                    g.setColor(new Color((int) (Math.random() * 0x10000)));
                    g.fillRect(
                            (int) (Math.random() * WINDOW_WIDTH - 170),
                            (int) (Math.random() * WINDOW_HEIGHT - 170),
                            (int) (Math.random() * 150),
